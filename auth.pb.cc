...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_auth_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::auth::CreateAccountWebFailure, failurereason_),
  0,
  1,
  ...
  PROTOBUF_FIELD_OFFSET(::auth::AuthenticateWebFailure, failurereason_),
  0,
  1,
};
...
const char descriptor_table_protodef_auth_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "Id\030\001 \002(\005\022;\n\rfailureReason\030\002 \002(\0162$.auth.C"
  "reateAccountWebFailure.reason\"U\n\006reason\022"
  ...
  "\001 \002(\005\022:\n\rfailureReason\030\002 \002(\0162#.auth.Auth"
  "enticateWebFailure.reason\"<\n\006reason\022\027\n\023I"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_auth_2eproto = {
  false, false, 687, descriptor_table_protodef_auth_2eproto, "auth.proto", 
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          ...
          if (PROTOBUF_PREDICT_TRUE(::auth::CreateAccountWebFailure_reason_IsValid(val))) {
            _internal_set_failurereason(static_cast<::auth::CreateAccountWebFailure_reason>(val));
          } else {
...
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:auth.CreateAccountWebFailure)
  size_t total_size = 0;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          ...
          if (PROTOBUF_PREDICT_TRUE(::auth::AuthenticateWebFailure_reason_IsValid(val))) {
            _internal_set_failurereason(static_cast<::auth::AuthenticateWebFailure_reason>(val));
          } else {
            ::PROTOBUF_NAMESPACE_ID::internal::WriteVarint(2, val, mutable_unknown_fields());
          }
        } else
...
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:auth.AuthenticateWebFailure)
  size_t total_size = 0;
