...
class CreateAccountWebFailure final :
 ...
 public:
  ...
  // required .auth.CreateAccountWebFailure.reason failureReason = 2;
  bool has_failurereason() const;
  private:
  bool _internal_has_failurereason() const;
  public:
  void clear_failurereason();
  ::auth::CreateAccountWebFailure_reason failurereason() const;
  void set_failurereason(::auth::CreateAccountWebFailure_reason value);
  private:
  ::auth::CreateAccountWebFailure_reason _internal_failurereason() const;
  void _internal_set_failurereason(::auth::CreateAccountWebFailure_reason value);
  public:
...
class AuthenticateWebFailure final :
 ...
 public:
  ...
  // required .auth.AuthenticateWebFailure.reason failureReason = 2;
  bool has_failurereason() const;
  private:
  bool _internal_has_failurereason() const;
  public:
  void clear_failurereason();
  ::auth::AuthenticateWebFailure_reason failurereason() const;
  void set_failurereason(::auth::AuthenticateWebFailure_reason value);
  private:
  ::auth::AuthenticateWebFailure_reason _internal_failurereason() const;
  void _internal_set_failurereason(::auth::AuthenticateWebFailure_reason value);
  public:
...
inline ::auth::CreateAccountWebFailure_reason CreateAccountWebFailure::_internal_failurereason() const {
  return static_cast< ::auth::CreateAccountWebFailure_reason >(failurereason_);
}
inline ::auth::CreateAccountWebFailure_reason CreateAccountWebFailure::failurereason() const {
  // @@protoc_insertion_point(field_get:auth.CreateAccountWebFailure.failureReason)
  return _internal_failurereason();
}
inline void CreateAccountWebFailure::_internal_set_failurereason(::auth::CreateAccountWebFailure_reason value) {
  assert(::auth::CreateAccountWebFailure_reason_IsValid(value));
  _has_bits_[0] |= 0x00000002u;
  failurereason_ = value;
}
inline void CreateAccountWebFailure::set_failurereason(::auth::CreateAccountWebFailure_reason value) {
  _internal_set_failurereason(value);
  // @@protoc_insertion_point(field_set:auth.CreateAccountWebFailure.failureReason)
}
...
inline ::auth::AuthenticateWebFailure_reason AuthenticateWebFailure::_internal_failurereason() const {
  return static_cast< ::auth::AuthenticateWebFailure_reason >(failurereason_);
}
inline ::auth::AuthenticateWebFailure_reason AuthenticateWebFailure::failurereason() const {
  // @@protoc_insertion_point(field_get:auth.AuthenticateWebFailure.failureReason)
  return _internal_failurereason();
}
inline void AuthenticateWebFailure::_internal_set_failurereason(::auth::AuthenticateWebFailure_reason value) {
  assert(::auth::AuthenticateWebFailure_reason_IsValid(value));
  _has_bits_[0] |= 0x00000002u;
  failurereason_ = value;
}
inline void AuthenticateWebFailure::set_failurereason(::auth::AuthenticateWebFailure_reason value) {
  _internal_set_failurereason(value);
  // @@protoc_insertion_point(field_set:auth.AuthenticateWebFailure.failureReason)
}
